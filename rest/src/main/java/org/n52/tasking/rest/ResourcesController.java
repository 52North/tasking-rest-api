...
public class ResourcesController {
    ...
    private Map<String, String> createResources(String fullUrl) {
        ...
        resources.put(UrlSettings.DEVICES_RESOURCE,
                String.format("%s/%s", fullUrl, UrlSettings.DEVICES_RESOURCE));
        resources.put(UrlSettings.RESULTS_RESOURCE,
                String.format("%s/%s", fullUrl, UrlSettings.RESULTS_RESOURCE));
        resources.put(UrlSettings.TASKS_RESOURCE,
                String.format("%s/%s", fullUrl, UrlSettings.TASKS_RESOURCE));
