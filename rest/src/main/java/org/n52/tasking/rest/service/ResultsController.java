...
import org.n52.tasking.core.service.ResultService;
...
@RestController
@RequestMapping(value = UrlSettings.API_V1_BASE + "/" + UrlSettings.RESULTS_RESOURCE,
...
public class ResultsController {
    ...
    public ModelAndView getResourceCollection(@RequestParam(required = false) MultiValueMap<String, String> query) throws Exception {
        ...
        List<Resource> list = this.service.getResults(fullUrl);
